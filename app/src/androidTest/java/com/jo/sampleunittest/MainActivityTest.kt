...
class MainActivityTest {
    ...
    fun getCircumference() {
        ...
        onView(withId(R.id.txt_result)).check(matches(withText(dummyCircumference)))
    }
    ...
    fun getSurfaceArea() {
        ...
        onView(withId(R.id.txt_result)).check(matches(isDisplayed()))
        onView(withId(R.id.txt_result)).check(matches(withText(dummySurfaceArea)))
    ...
    fun getVolume() {
        ...
        onView(withId(R.id.txt_result)).check(matches(isDisplayed()))
        onView(withId(R.id.txt_result)).check(matches(withText(dummyVolume)))
    }
